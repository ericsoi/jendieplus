<?php
    ...
    if (isset($_SESSION["username"])){
        ...
        if($user){
            $user_info=$user;
            $underwriters=selectunderwriter("SELECT * FROM tbl_underwriter ORDER BY RAND()");
            if($underwriters){
                                        ...
                                        <tr>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <div class="flex px-2 py-1">
                                                    <div>
                                                        <img src="<?php echo $img?>" class="inline-flex items-center justify-center mr-4 text-white transition-all duration-200 ease-soft-in-out text-size-sm h-9 w-9 rounded-xl" alt="user1" />
                                                    </div>
                                                    <div class="flex flex-col justify-center">
                                                        <h6><?php echo $underwriters[$key]->Name?></h6>
                                                        <p class="mb-0 leading-tight text-size-xs text-slate-400"><?php echo $underwriters[$key]->EMAIL_ADDRESS?></p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                <p class="mb-0 font-semibold leading-tight text-size-xs"><?php echo $underwriters[$key]->paybill?></p>
