                        ...
                        <div class="max-w-full px-3 mb-4 lg:mb-0 lg:w-full lg:flex-none">
                            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                                <div class="p-4 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                            <h6 class="mb-0">Validate Certificate</h6>
                                        </div>
                                ...
                                <div class="flex-auto p-4">
                                    <div class="">
                                        <div class="">
                                            <form role="form" action="processor/handle_validate_cert.php" method="post">
                                                
                                                <div class="mb-8">
                                                    <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Vehicle Reg</label>
                                                    <input type="text"  name="vehiclereg" class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding  py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                    placeholder="Enter Vehicle reg" aria-label="Email" aria-describedby="email-addon" required/>
                                                    <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Chasis No</label>
                                                    <input type="text"  name="chasis_no" class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding  py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                    placeholder="Enter Vehicle Chasis Number" aria-label="Email" aria-describedby="email-addon" required/>
                                                    ...
                                                    placeholder="Enter Cert No" aria-label="Email" aria-describedby="email-addon" required/>
                                                </div>
                                                <?php
                                                if(isset($_SESSION["valid_cert"])){
                                                    if($_SESSION["valid_cert"] == true){
                                                    $object = $_SESSION["ValidateInsurance"];                                        
                                                ?>
                                                    <div class="flex justify-center">
                                                        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                                                            <div class="p-6 flex flex-col justify-start">
                                                            <h5 class="text-gray-900 text-xl font-medium mb-2">Valid</h5>
                                                            <p class="text-gray-700 text-base mb-4">
                                                            <b> Certificate Number</b>: <?php echo $object["CertificateNumber"]?><br>
                                                            <b> Policy Number</b>: <?php echo $object["InsurancePolicyNumber"]?><br>
                                                            <b> Valid From</b>: <?php echo $object["ValidFrom"]?><br>
                                                            <b> Valid Till</b>: <?php echo $object["ValidTill"]?><br>
                                                            <b> Insured By</b>: <?php echo $object["InsuredBy"]?><br>
                                                            <b> CChassis Number</b>: <?php echo $object["Chassisnumber"]?><br>
                                                            <b> Policy Holder</b>: <?php echo $object["sInsuredName"]?><br>
                                                            <b> Intermediary</b>: <?php echo $object["Intermediary"]?><br>
                                                            <b> Intermediary IRA</b>: <?php echo $object["IntermediaryIRA"]?><br>
                                                            <b> Certificate Status</b>: <?php echo $object["CertificateStatus"]?><br>
                                                            <b> Is Digital Certificate</b>: <?php echo $object["IsDigitalCertificate"]?><br>
                                                            <b> Certificate Classification Name</b>: <?php echo $object["CertificateClassificationName"]?><br>
                                                            <b> Carying Capacity</b>: <?php echo $object["CarryingCapacity"]?><br>
                                                            <b> Tonnage </b>: <?php echo $object["Tonnage"]?><br>
                                                            <b> Make</b>: <?php echo $object["make"]?><br>
                                                            <b> Model</b>: <?php echo $object["model"]?><br>
                                                ...
                                                <?php
                                                    unset($_SESSION["double_insured"]);
                                                    }else{
                                                        $obj = $_SESSION["ValidateInsurance"];
                                                        $cert = $_SESSION["cert"];
                                                        echo  "$cert <div style='color:red;'>$obj</div> Countercheck Vehicle Reg, Chasis and Cert No";
