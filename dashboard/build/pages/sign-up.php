                ...
                <div class="container z-10">
                    <div class="flex flex-wrap justify-center -mx-3">
                        <div class="w-full max-w-full px-3 mx-auto mt-0 text-center lg:flex-0 shrink-0 lg:w-5/12">
                            ...
                            <p class="text-white">Login or create new account.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="flex-auto p-6">
                                <form action="../../processor/handle_register.php" method="POST" role="form text-left">
                                    ...
                                    <div class="min-h-6 pl-6.92-em mb-0.5 block">
                                        ...
                                        <label class="mb-2 ml-1 font-normal cursor-pointer select-none text-size-sm text-slate-700" for="terms"> I agree the <a href="#" class="font-bold text-slate-700">Terms and Conditions</a> </label>
                                    </div>
