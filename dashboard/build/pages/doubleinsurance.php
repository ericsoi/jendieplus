                        ...
                        <div class="max-w-full px-3 mb-4 lg:mb-0 lg:w-full lg:flex-none">
                            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                                <div class="p-4 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                            <h6 class="mb-0">Validate Double Insurance</h6>
                                        </div>
                                ...
                                <div class="flex-auto p-4">
                                    <div class="">
                                        <div class="">
                                            <form role="form" action="processor/handle_doubleinsyrance.php" method="post">
                                                ...
                                                <div class="mb-8">
                                                    ...
                                                    placeholder="Enter Vehicle reg" aria-label="Email" aria-describedby="email-addon" />
                                                </div>
                                                <?php
                                                if(isset($_SESSION["double_insured"])){
                                                    if($_SESSION["double_insured"] == true){
                                                    $object = $_SESSION["double_insurance"];                                        
                                                ?>
                                                    <div class="flex justify-center">
                                                        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-lg">
                                                            <img class=" w-full h-96 md:h-auto object-cover md:w-40 rounded-t-lg md:rounded-none md:rounded-l-lg" src="https://jendieplus.co.ke/img/logo.pnsg" alt="" />
                                                            <div class="p-6 flex flex-col justify-start">
                                                            <h5 class="text-gray-900 text-xl font-medium mb-2">Covered</h5>
                                                            <p class="text-gray-700 text-base mb-4">
                                                            <b> Underwriter</b>: <?php echo $object[0]["MemberCompanyName"]?><br>
                                                            <b> Cert No</b>: <?php echo $object[0]["InsuranceCertificateNo"]?><br>
                                                            <b> Reg No</b>: <?php echo $object[0]["RegistrationNumber"]?><br>
                                                            <b> Chasis No</b>: <?php echo $object[0]["ChassisNumber"]?><br>
                                                            <b> Cover End Date</b>: <?php echo $object[0]["CoverEndDate"]?><br>
                                                ...
                                                <?php
                                                    unset($_SESSION["double_insured"]);
                                                        ...
                                                        $obj = $_SESSION["double_insurance"];
                                                        $reg = $_SESSION["reg"];
                                                        echo  "$reg <div style='color:red;'>$obj</div>";
