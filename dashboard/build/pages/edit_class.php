                                    ...
                                    <div class="">
                                        <div class="">
                                            <form role="form" action="#" method="post">
                                                ...
                                                <div class="mb-8">
                                                    <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">select column to update</label>
                                                    <select name="column" class="form-select appearance-none
                                                        block
                                                        w-full
                                                        px-3
                                                        py-1.5
                                                    ...
                                                    <input type="text"  name="value" class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding  py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                     aria-label="Email" placeholder="Enter desireble value" aria-describedby="email-addon" required />
                                                </div>                                                   
                                                <div class="flex-none max-w-full px-3 text-right">
                                                <input type="button"  onclick="window.location='classes.php';"  class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" value="Back"/></i>
