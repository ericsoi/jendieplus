                                ...
                                <div class="p-4 pb-0 mb-0 bg-white border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                                    <div class="flex flex-wrap -mx-3">
                                        <div class="flex items-center flex-none w-1/2 max-w-full px-3">
                                            <h6 class="mb-0">Get Cover History</h6>
                                        </div>
                                                ...
                                                <div class="flex flex-col">
                                                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                                                        ...
                                                        <div class="overflow-hidden">
                                                            ...
                                                            <tbody>
                                                            <?php
                                                                if(isset($_SESSION['vehicle_history'])){
                                                                    $counter = 0;
                                                                    $data = $_SESSION['vehicle_history'];
                                                                    ...
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['RegistrationNumber'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['ChassisNumber'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['EngineNumber'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['Make'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['Model'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['TypeOfBody'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['YearOfManufacture'];?>
                                                                    </td>
                                                                    <td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                                                        <?php echo $data[$counter]['CarryingCapacity'];?>
                                                                    </td>
