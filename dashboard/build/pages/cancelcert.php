                        ...
                        <div class="max-w-full px-3 mb-4 lg:mb-0 lg:w-full lg:flex-none">
                            <div class="relative flex flex-col min-w-0 mt-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                                ...
                                <div class="flex-auto p-4">
                                    <div class="">
                                        <div class="">
                                            <form role="form" action="processor/handle_cancel_cert.php" method="post">
                                                ...
                                                <div class="mb-8">
                                                    ...
                                                    <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Cancelation Date</label>
                                                    <input type="date"  name="date" class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding  py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                    placeholder="Enter Vehicle Chasis Number" aria-label="Email" aria-describedby="email-addon" required/>
                                                    <label class="mb-2 ml-1 font-bold text-size-xs text-slate-700">Cancelation Reason</label>
                                                    <input type="text"  name="reason" class="focus:shadow-soft-primary-outline text-size-sm leading-5.6 ease-soft block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding  py-2 font-normal text-gray-700 transition-all focus:border-fuchsia-300 focus:outline-none focus:transition-shadow"
                                                    placeholder="Enter cancelation reason" aria-label="Email" aria-describedby="email-addon" required/>
                                                </div>
                                               <?php
                                               if(isset($_SESSION["cert_cancel"])){
                                                print_r($_SESSION["cert_cancel"]);
                                               }
                                               ?>
