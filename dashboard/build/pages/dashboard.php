...
?>
        ...
        <div class="w-full px-6 py-6 mx-auto">
                                ...
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-0 font-bold">
                                            KES0
                                            <span class="leading-normal text-size-sm font-weight-bolder text-lime-500">0</span>
                                        </h5>
                                    </div>
                                </div>
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">Today's User,s</p>
                                        <h5 class="mb-0 font-bold">
                                            0
                                            <span class="leading-normal text-size-sm font-weight-bolder text-lime-500">+0%</span>
                                        </h5>
                            ...
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        ...
                                        <h5 class="mb-0 font-bold">
                                            0
                                            <span class="leading-normal text-red-600 text-size-sm font-weight-bolder">0%</span>
                                        </h5>
                                    </div>
                                </div>
                                <div class="px-3 text-right basis-1/3">
                    ...
                    <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                        <div class="flex-auto p-4">
                            <div class="flex flex-row -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans font-semibold leading-normal text-size-sm">New Claims</p>
                                        <h5 class="mb-0 font-bold">
                                            0
                                            <span class="leading-normal text-size-sm font-weight-bolder text-lime-500">0</span>
                                        </h5>
                ...
                <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
                    <div class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                        <div class="flex-auto p-4">
                            ...
                            <p class="ml-2 leading-normal text-size-sm">(<span class="font-bold">0%</span>) than last week</p>
                                ...
                                <g transform="translate(1716.000000, 291.000000)">
                                  <g transform="translate(4.000000, 301.000000)">
                                    ...
                                    <path class="color-background" d="M36.0983333,22.7383333 C36.9280725,27.5056357 35.3832611,32.3782594 31.9583333,35.7966667 C31.0587397,36.6879974 30.0508686,37.4629382 28.9583333,38.1033333 C28.3033941,38.4890431 27.4704606,38.3827841 26.9333333,37.845 L23.6166667,34.53 C28.5053053,31.4496338 32.7452344,27.4440926 36.0983333,22.7383333 L36.0983333,22.7383333 Z" opacity="0.598539807"></path>
                                            ...
                                            <p class="mt-1 mb-0 font-semibold leading-tight text-size-xs">Quotations</p>
                                        </div>
                                        <h4 class="font-bold">0</h4>
                                        <div class="text-size-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                    ...
                    <div class="border-black/12.5 shadow-soft-xl relative z-20 flex min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border">
                        <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                            ...
                            <p class="leading-normal text-size-sm">
                                ...
                                <span class="font-semibold">0% more</span> in 2022
                            </p>
                        </div>
                        <div class="flex-auto p-4">
                            <div>
            ...
            <div class="flex-auto p-4 ">
                ...
                <a href="../../../underwriter.php?q=<?php echo $id?>">
