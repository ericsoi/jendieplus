...
<head>
	...
	<link rel="apple-touch-icon" type="image/x-icon" href="img/logo2.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href="img/logo2.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href="img/logo2.png">
	<link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href="img/logo2.png">
			...
			<div class="container">
				<div class="row">
					...
					<nav class="col-md-9 col-sm-9 col-xs-9">
						...
						<div class="main-menu">
							<div id="header_menu">
								<img src="img/logo2.png" alt="JendiePlus" data-retina="true">
							</div>
...
@keyframes spin {
	...
	<!-- Google tag (gtag.js) -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-4YGDSH48QX"></script>
	<script>
	window.dataLayer = window.dataLayer || [];
	function gtag(){dataLayer.push(arguments);}
	gtag('js', new Date());

	gtag('config', 'G-4YGDSH48QX');
</script>
</head>
