...
<head>
	...
	<meta name="author" content="JendiePlus Technologie">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-6 col-xs-12">
							<a href="tel:+254722301062 +254733566464" id="phone_top">+254722301062 +254733566464</a>
						</div>
			...
			<div class="row">
				...
				<aside class="col-md-3">
					<div class="box_style_2">
						...
						<p>
							Equity Bank Building Third floor suite 202,
Ngara Rd, Nairobi.
		...
		<div class="container">
			<div class="row">
				<div class="col-md-3 col-sm-3">
					<h3>Need help?</h3>
					<a href="tel:+254722301062 +254733566464" id="phone">+254722301062 +254723775289</a>
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<span id="copy">Copyright © 2021. All rights reserved</span>
				</div>
