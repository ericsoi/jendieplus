            ...
            <div class="box-body">
              <div class='detail-text'>
                  ...
                  <?php if($_SESSION['role']== "Super-Admin"){ ?>
                    <label for="name"><strong>Referal Code:</strong></label>
                    <span class='text-data'> <?php echo $_SESSION['code'] ?></span><br>
                    <?php
                      }
                    ?>
                  <label for="name"><strong>Authority:</strong></label>
                  <span class='text-data'> <?php echo $row->role;?></span><br>
                  <label for="name"><strong>Agent Code:</strong></label>
                  <span class='text-data'> <?php echo $row->sub_agent;?></span><br>
              </div>
            </div>
