        ...
        <div class="box">
          ...
          <div class="box-body" style="overflow-x:auto;">
            <table class="table table-striped" id="mySatuan">
                ...
                echo $usercode;
                if( $user->role=="agency"){
                    $select = $pdo->prepare("SELECT * FROM tbl_user where agency = '$usercode'");
                    // echo $user->role;
                    // echo "<script>alert('oper')</script>";
                } elseif ( $user->role=="sub-agent"){
                    echo "<script>alert('sub-agent')</script>";
                    $select = $pdo->prepare("SELECT * FROM tbl_user where subagent = '$usercode'");
                }
                $select->execute();
