...
if(isset($_POST['reset_pass'])){
	...
	$select=$pdo->prepare("SELECT * from tbl_user where (phonenumber='$username' or emailaddress='$username')");
	...
	// }cd137ef6ed9a9417ff18e51b0671703e
    $select->execute();
	print_r($select->rowCount());
	if($select->rowCount()){
		$row = $select->fetch(PDO::FETCH_ASSOC);

		$update = $pdo->prepare("UPDATE tbl_user SET password='$password' WHERE (phonenumber='$username' or emailaddress='$username')");
					...
					<div>
						...
						<form method="post" action="#" id="contactform">
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Email/Phone" name="username" id="username" required>
							...
							<div class="row">
								<div class="col-md-6 col-sm-6">
									  ...
									  <label>Confirm Password</label>
                    					<input type="password" class="form-control" placeholder="Confirm Password" id="confirm_password" name="confirm_password" required onchange="handleChange(this.value)">
                    					<span class="glyphicon glyphicon-lock form-control-feedback"></span>
                  					</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<p>
										<input type="submit" value="Submit" class="btn_1" name="reset_pass" id="submit-contact">
							...
							<?php
								...
								if( $message == "Success"){
									...
									echo'<script type="text/javascript">
									jQuery(function validation(){
									swal("Update Failed", "User not found", "Error", {
									button: "Continue",
										});
									});
								</script>';
...
<script>
	...
	function handleChange(value){
		...
		if (password !== confirm_password){
			...
			document.getElementById("confirm_password").placeholder = "Password Didnt Match";
		}
	}
