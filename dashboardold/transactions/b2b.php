<?php
		...
		$vehicle_registration = $_SESSION["registration"];
		...
		$sql = "SELECT paybill from tbl_underwriter where Name like'%$underwriter_name%'";
		...
		$curl_post_data = array(
			...
			'QueueTimeOutURL' => 'https://bimaplus.co.ke/transactions/b2b_confirmation_url.php',
			'ResultURL' => 'https://bimaplus.co.ke/transactions/b2b_confirmation_url.php'
		);
