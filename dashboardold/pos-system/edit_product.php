                    ...
                    <div class="col-md-6">
                        <ul class="list-group">
                            ...
                            <div class="form-group">
                                <label for="">Optional Benefits</label>
                                <input type="hidden" class="form-control" value="<? echo $row->product_code;?>">
                                <input type="number" class="form-control"
                                name="optionalname" id="optionalname" value="<?php echo $optionalname_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Optional Benefits Premium</label>
                                <input type="text" class="form-control"
                                name="optionalpremium" id="optionalpremium"  value="<?php echo $optionalpremium_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Optional Benefits Rate</label>
                                <input type="text" class="form-control"
                                name="optionalrate" id="optionalrate" value="<?php echo $optionalrate_db; ?>">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="">Weekly Rates</label>
                                <input type="text" class="form-control"
                                name="weeklyrates" id="weeklyrates" value="<?php echo $weeklyrates_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Fortnight Rates</label>
                                <input type="text" class="form-control"
                                name="fortnightrates" id="fortnightrates"  value="<?php echo $fortnightrates_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Minimum Sum Insured</label>

                                <input type="text" class="form-control"
                                name="minsum" id="minsum"  value="<?php echo $minsum_db; ?>">
                            </div>
                        </ul>
                    </div>
                    <div class="col-md-6">
                        <ul class="list-group">
                            ...
                            <div class="form-group">
                                <label for="">Number of Passangers</label>
                                <input type="text" class="form-control"
                                name="passangers" id="passangers"  value="<?php echo $passangers_db; ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="">Excluded Vehicles</label>
                                <input type="text" class="form-control"
                                name="excludedvehicles" id="excludedvehicles" value="<?php echo $excludedvehicles_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Minimum Premium</label>
                                <input type="text" class="form-control"
                                name="minimumpremium" id="minimumpremium"  value="<?php echo $minimumpremium_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Maximum Age</label>
                                <input type="text" class="form-control"
                                name="maxage" id="maxage"  value="<?php echo $maxage_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Minimum Age</label>
                                <input type="text" class="form-control"
                                name="minage" id="minage"  value="<?php echo $minage_db; ?>">
                            </div>
                            <div class="form-group">
                                <label for="">Maximum Sum Insured</label>
                                <input type="text" class="form-control"
                                name="maxsum" id="maxsum"  value="<?php echo $maxsum_db; ?>">
                            </div>
                        </ul>
                    </div>
