...
<head>
  ...
  <title>Bimaplus | Dashboard</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="index2.html" class="logo">
        ...
        <span class="logo-lg"><b>Bimaplus|</b>Dashboard</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="./register.php"><i class="fa fa-users"></i> <span>Clients</span></a></li>
          <li><a href="./product.php"><i class="fa fa-archive"></i> <span>Agents</span></a></li>
