...
<head><meta charset="utf-8">
	...
	<title>JeniePlus :: Smart INSURANCE Mkononi</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div id="logo_home">
							<h1><a href="index.php" title="JendiePlus">JendiePlus&amp;Insurance Technoogies</a></h1>
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div>
						...
						<form method="post" action="handle_register.php" id="contactform">
							<div class="row">
							...
							<div class="row">
								<div class="col-md-8 col-lg-8">
									<div class="form-group has-feedback">
										<input type="password" class="form-control" placeholder="confirm password" name="confirmpassword" id="confirmpassword"  required onchange="handleChange(this.value)">
										<span class="glyphicon glyphicon-lock form-control-feedback"></span>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-8">
									<input type="submit" class="btn btn-primary btn-lg btn-block" name="btn_login">
									...
									if(isset($_GET["status"])){
										...
										if($message == "error"){
											echo'<script type="text/javascript">
												...
												swal("Registration successful", "An error occured. Trie again latter", "success", {
												button: "Continue",
													}).then(function() {
											...
											echo'<script type="text/javascript">
												jQuery(function validation(){
												swal("Registration Failed", "Email/Phone already registered", "error", {
												button: "Continue",
													}).then(function() {
														window.location = "register.php";
													});
											...
											echo'<script type="text/javascript">
												jQuery(function validation(){
												swal("Registration Sucessful", "Use email or phone to log in", "success", {
												button: "Continue",
													}).then(function() {
										...
										}elseif($message=="codeerror"){
											echo'<script type="text/javascript">
												jQuery(function validation(){
												swal("Registration Failed", "code error", "Error", {
												button: "Continue",
													}).then(function() {
														window.location = "index.php";
													});
...
<script>
	...
	function handleChange(value){
		...
		if(password.length < 6){
			console.log("error");
			document.getElementById("password").value = "";
			document.getElementById("password").placeholder = "Length didnt match required length";
		}
	}
</script>
</body>
