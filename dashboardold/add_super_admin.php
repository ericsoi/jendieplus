                ...
                <form action="" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="category">Add Super Admin</label>
                      <input type="text" class="form-control" name="superadmin" placeholder="Enter admin email">
                    </div>
                  </div><!-- /.box-body -->
      ...
      <div class="col-md-8">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Super Admin List</h3>
          </div>
          <!-- /.box-header -->
