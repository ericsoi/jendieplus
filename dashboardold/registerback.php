...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $select = $pdo->prepare("SELECT id FROM users WHERE username = '$username'");
		$select->execute();
        ...
        // if($stmt = mysqli_prepare($connection, $select)){
...
<head>
	...
	<meta name="author" content="JendiePls Technologies">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-3">
						<div id="logo_home">
							<h1><a href="../index.html" title="JendiePlus">JendiePlus&amp;Insurance Technologies</a></h1>
						</div>
					</div>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-4">
										<div class="form-group">
											...
											<input class="form-control py-1" name="krapincopy" id="krapincopy" type="file" value="<?php echo $krapincopy; ?>" placeholder="ira copy" />
