							...
							<div class="row">
								<div class="col-md-4 col-sm-4">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control styled" id="firstname" value="<?php echo $_SESSION['firstname']?>" name="firstname" placeholder="Full Name">
									</div>
									<div class="form-group">
										<label>Last Name</label>
										<input type="text" class="form-control styled" id="lastname" value="<?php echo $_SESSION['lastname']?>" name="lastname"  placeholder="Full Name">
									</div>
									<div class="form-group">
