...
//      }';
    ...
    if (count($jdata) == 1){
        ...
        $sql = "INSERT INTO tbl_mpesa_transactions (code, TransID, TransTime, TransAmount, MSISDN, FirstName, MiddleName, LastName, ResultDesc, BillRefNumber) VALUES ('$code', '$TransID', '$TransTime', '$TransAmount', '$MSISDN', '$FirstName', '$MiddleName', '$LastName', '$ResultDesc', '$BillRefNumber')";
